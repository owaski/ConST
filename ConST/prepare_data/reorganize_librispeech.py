...
output_directory = '/mnt/data/siqiouyang/datasets/librispeech/LibriSpeech/librispeech_mfa'
librispeech_root = '/mnt/data/siqiouyang/datasets/librispeech/LibriSpeech/'
