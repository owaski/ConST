...
tag=ablation_data_efficiency_10h_token_deep
...
fairseq-train /mnt/data/siqiouyang/datasets/must-c-v1.0 \
    ...
    --train-subset train-10h_st,train-10h_asr --valid-subset dev_st_${TGT_LANG} \
    ...
    --contrastive-weight 1.0 1.0 --contrastive-temperature 0.05 0.05 --contrastive-seqlen-type none --contrastive-level token \
    \
