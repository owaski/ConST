...
tag=ablation_data_efficiency_1h_40h_cross_cos
...
fairseq-train /mnt/data/siqiouyang/datasets/must-c-v1.0 \
    ...
    --train-subset train-1h_st,train-1h_asr_40h --valid-subset dev_st_${TGT_LANG} \
    ...
    --contrastive-weight 1.0 --contrastive-temperature 0.05 --contrastive-seqlen-type none --contrastive-level cross_attention_cos \
    \
