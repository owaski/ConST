...
tag=ablation_data_efficiency_1h_token_deep_v2
...
fairseq-train /mnt/data/siqiouyang/datasets/must-c-v1.0 \
    --distributed-world-size $num_gpus --all-gather-list-size 32768 \
    ...
    --contrastive-weight 1.0 1.0 --contrastive-temperature 0.05 0.2 --contrastive-seqlen-type none --contrastive-level token \
    \
