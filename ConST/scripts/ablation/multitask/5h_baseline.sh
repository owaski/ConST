...
tag=ablation_data_efficiency_5h_baseline
...
fairseq-train /mnt/data/siqiouyang/datasets/must-c-v1.0 \
    ...
    --train-subset train-5h_st --valid-subset dev_st_${TGT_LANG} \
    ...
    --contrastive-weight 0.0 0. --contrastive-temperature 0.0 0. --contrastive-seqlen-type none --contrastive-level token \
    \
