...
tag=ablation_data_efficiency_1h_token_deep
...
fairseq-train /mnt/data/siqiouyang/datasets/must-c-v1.0 \
    ...
    --contrastive-weight 1.0 --contrastive-temperature 0.05 --contrastive-seqlen-type none --contrastive-level token --deep-supervision \
    \
