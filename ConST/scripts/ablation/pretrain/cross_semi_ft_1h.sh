...
tag=ablation_pretrain_cross_semi_ft_1h

TGT_LANG=de
MODEL_DIR=/mnt/data/siqiouyang/runs/ConST/$tag

mkdir -p ${MODEL_DIR}
cp /mnt/data/siqiouyang/runs/ConST/ablation_pretrain_cross/checkpoint_best.pt /mnt/data/siqiouyang/runs/ConST/$tag/checkpoint_last.pt
...
fairseq-train /mnt/data/siqiouyang/datasets/must-c-v1.0 \
    ...
    --contrastive-weight 1.0 --contrastive-temperature 0.05 --contrastive-seqlen-type none --contrastive-level cross_attention \
    \
