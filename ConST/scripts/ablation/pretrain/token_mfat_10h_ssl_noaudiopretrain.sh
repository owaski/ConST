...
tag=ablation_pretrain_token_mfat_10h_ssl_noaudiopretrain
...
fairseq-train /mnt/data/siqiouyang/datasets/must-c-v1.0 \
    ...
    --criterion multi_task_cross_entropy_with_contrastive_token_ssl_with_extra_MT \
    --ssl-weight 1.0 \
    ...
    --save-dir ${MODEL_DIR} \
    --ddp-backend=no_c10d \
    --reset-optimizer --reset-dataloader --all-gather-list-size 16384 \
