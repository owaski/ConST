...
tag=ablation_pretrain_pseudo_token_11h_0.02
...
fairseq-train /mnt/data/siqiouyang/datasets/must-c-v1.0 \
    ...
    --contrastive-weight 1.0 0.0 --contrastive-temperature 0.02 0.02 --contrastive-seqlen-type none --contrastive-level token \
    \
