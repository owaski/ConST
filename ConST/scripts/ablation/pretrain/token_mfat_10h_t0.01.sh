...
tag=ablation_pretrain_token_mfat_10h_t0.01
...
fairseq-train /mnt/data/siqiouyang/datasets/must-c-v1.0 \
    ...
    --contrastive-weight 1.0 0.0 --contrastive-temperature 0.01 0.01 --contrastive-seqlen-type none --contrastive-level token \
    \
