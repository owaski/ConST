...
tag=ablation_pretrain_ctc_phoneme_100h_ft_1h

TGT_LANG=de
MODEL_DIR=/mnt/data/siqiouyang/runs/ConST/$tag

mkdir -p ${MODEL_DIR}
cp /mnt/data/siqiouyang/runs/ConST/ablation_pretrain_ctc_phoneme_100h/checkpoint_best.pt /mnt/data/siqiouyang/runs/ConST/$tag/checkpoint_last.pt
...
fairseq-train /mnt/data/siqiouyang/datasets/must-c-v1.0 \
    ...
    --best-checkpoint-metric accuracy --maximize-best-checkpoint-metric --reset-optimizer --reset-dataloader 
    # \
