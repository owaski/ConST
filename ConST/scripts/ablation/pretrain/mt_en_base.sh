...
MODEL_DIR=/mnt/data7/siqiouyang/runs/ConST/$tag
# pretrain_ckpt=wmt16_ende_xstnet_pretrain.pt

mkdir -p ${MODEL_DIR}
# cp /mnt/data/siqiouyang/runs/ConST/pretrained/$pretrain_ckpt /mnt/data3/siqiouyang/runs/ConST/$tag/checkpoint_last.pt
