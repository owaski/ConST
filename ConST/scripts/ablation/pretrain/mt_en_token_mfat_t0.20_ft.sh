...
tag=mt_en_token_mfat_t0.20_ft

MODEL_DIR=/mnt/data3/siqiouyang/runs/ConST/$tag

mkdir -p ${MODEL_DIR}
cp /mnt/data3/siqiouyang/runs/ConST/mt_en_token_mfat_t0.20/checkpoint_best.pt /mnt/data3/siqiouyang/runs/ConST/$tag/checkpoint_last.pt
