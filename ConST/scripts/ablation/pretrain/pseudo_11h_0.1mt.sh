...
tag=ablation_pretrain_pseudo_11h_0.1mt

TGT_LANG=de
pretrain_ckpt=checkpoint.0.1wmt.best_bleu_avg.pt
...
fairseq-train /mnt/data/siqiouyang/datasets/must-c-v1.0 \
    ...
    --train-subset train_pseudo_st_10h,train-1h_st --valid-subset dev_st_${TGT_LANG} \
    ...
    --contrastive-weight 0.0 0.0 --contrastive-temperature 0.05 0.05 --contrastive-seqlen-type none --contrastive-level sentence \
    \
