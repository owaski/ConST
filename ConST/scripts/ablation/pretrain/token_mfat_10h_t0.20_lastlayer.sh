...
tag=ablation_pretrain_token_mfat_10h_t0.20_lastlayer
...
fairseq-train /mnt/data/siqiouyang/datasets/must-c-v1.0 \
    ...
    --contrastive-weight 0.0 1.0 --contrastive-temperature 0.20 0.20 --contrastive-seqlen-type none --contrastive-level token \
    \
