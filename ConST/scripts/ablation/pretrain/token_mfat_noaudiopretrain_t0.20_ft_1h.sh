...
tag=ablation_pretrain_token_mfat_noaudiopretrain_t0.20_ft_1h

TGT_LANG=de
MODEL_DIR=/mnt/data/siqiouyang/runs/ConST/$tag

mkdir -p ${MODEL_DIR}
cp /mnt/data/siqiouyang/runs/ConST/ablation_pretrain_token_mfat_noaudiopretrain_t0.20/checkpoint_best.pt /mnt/data/siqiouyang/runs/ConST/$tag/checkpoint_last.pt
...
python fairseq_cli/train.py /mnt/data/siqiouyang/datasets/must-c-v1.0 \
    ...
    --save-interval-updates 1000 --save-interval 5 \
