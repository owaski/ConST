...
fairseq-train /mnt/data/siqiouyang/datasets/must-c-v1.0 \
    ...
    --contrastive-weight 1.0 --contrastive-temperature 0.01 --contrastive-seqlen-type none --contrastive-level token \
    \
...
# sbatch --nodes=1 --ntasks=1 --cpus-per-task=24 --mem=64GB --gpus=2 --time=1-0:0:0 --mail-type=all --mail-user=siqiouyang@ucsb.edu --output=runs/main_ende_token_0.01_stdout.txt --error=runs/main_ende_token_0.01_stderr.txt ConST/scripts/main/ende_token_0.01_cont.sh